# Contributing to gh-lazydispatch
...
Follow [AGENTS.md](AGENTS.md) for code organization, testing patterns, and error handling. [docs/go-best-practices.md](docs/go-best-practices.md) carries the worked examples.
...
[docs/troubleshooting.md](docs/troubleshooting.md) covers the toolchain failures that look like project bugs: an empty `GOPROXY` from a corrupt mise Go install, a `compile` loaded from a second `GOROOT`, and golden fixtures rewritten on commit.
